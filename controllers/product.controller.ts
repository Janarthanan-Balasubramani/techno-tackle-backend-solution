...
const softDeleteProductCategory = asyncHandler(
  async (req: Request, res: Response) => {
    await ProductService.softDeleteProductCategory(req.body);
  },
);

const getAllproductsMappedUnderStore = asyncHandler(
  async (req: Request, res: Response) => {
    const data = await ProductService.getAllproductsMappedUnderStore(
      req.query.storeId,
    );
    ApiResponse.send(
      res,
      HttpStatus.OK.code,
      'Products mapped under store fetched successfully',
      data,
    );
    return;
  },
...
const getaAllproductCategroyUnderStore = asyncHandler(
  async (req: Request, res: Response) => {
    const data = await ProductService.getAllProductCategoryMappedUnderStore(
      req.query.storeId,
    );
    ApiResponse.send(
      res,
      HttpStatus.OK.code,
      'Product category mapped under store fetched successfully',
      data,
    );
    return;
  },
...
const ProductController = {
  ...
  getaAllproductCategroyUnderStore,
};
