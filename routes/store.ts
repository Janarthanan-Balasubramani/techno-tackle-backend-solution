...
import { createGroceryStore, createStoreSchema, deleteStoreSchema, updateStoreSchema } from '../schema/store';
...
router.post('/groceryStore',validate(createGroceryStore,ValidationSource.BODY),StoreController.createGroceryStore)
